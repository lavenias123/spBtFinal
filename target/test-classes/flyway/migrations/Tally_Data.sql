...
VALUES ('Dan', 'BoshDan', 'info@BoshDan.com', '213-666-4444'), 
        ...
        ('Sandra', 'Katelers', 'Sandra@d133tm.org', '403-232-0880'),
        ('Dennis', 'Menace', 'dennisM@dennisMenace.com', '756-882-4466'),
        ('Bengy', 'Childs', 'BengyC@dwp-1090.org', '313-522-0077')
		
;
INSERT INTO user_goals (user_fk, calorie_limit, daily_calorie_total, carbs_grams_limit)
VALUES (1, 1200, 1575, 435),
	(2, 1300, 1100, 300),
	(3, 1400, 1475, 435),
	(4, 1450, 1200, 435),
	(5, 1525, 1585, 435),
